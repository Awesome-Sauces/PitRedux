    ...
    public swordEnchantLores(String enchant) {
        switch (enchant) {
            ...
            case "exeIII":
                ...
                this.lore.add("&7Hitting an enemy to below &c3.5(HEART_EMOJI)");
                this.lore.add("&7instantly kills them");
                break;
            case "exeII":
                assert false;
                this.lore.add("&dRARE! &9Executioner II");
                this.lore.add("&7Hitting an enemy to below &c2.5(HEART_EMOJI)");
                this.lore.add("&7instantly kills them");
                break;
            case "exeI":
                assert false;
                this.lore.add("&dRARE! &9Executioner");
                this.lore.add("&7Hitting an enemy to below &c1.5(HEART_EMOJI)");
                this.lore.add("&7instantly kills them");
                break;
            case "billIII":
                assert false;
            ...
            case "perunIII":
                ...
                this.lore.add("&elightning&7 for &c1(HEART_EMOJI)&7 + &c1(HEART_EMOJI)");
            ...
            case "perunII":
                ...
                this.lore.add("&7Each &efourth&7 hit strikes");
                this.lore.add("&elightning&7 for &c2(HEART_EMOJI)&7.");
                this.lore.add("&7&oLightning deals true damage");
                break;
            case "perunI":
                assert false;
                ...
                this.lore.add("&elightning&7 for &c1.5(HEART_EMOJI)&7.");
                this.lore.add("&7&oLightning deals true damage");
                break;
            case "gambIII":
                assert false;
                this.lore.add("&dRARE! &9Gamble! III");
                this.lore.add("&d50% chance &7to deal &c3(HEART_EMOJI)&7 true");
            ...
            case "gambII":
                ...
                this.lore.add("&d50% chance &7to deal &c2(HEART_EMOJI)&7 true");
                this.lore.add("&7damage to whoever you hit, or to");
                this.lore.add("&7yourself");
                break;
            case "gambI":
                ...
                this.lore.add("&d50% chance &7to deal &c1(HEART_EMOJI)&7 true");
                this.lore.add("&7damage to whoever you hit, or to");
                this.lore.add("&7yourself");
                break;
                // ^ All Rares
            ...
            case "sharkIII":
                ...
                this.lore.add("&7player below &c6(HEART_EMOJI)&7 within 12");
            ...
            case "lsIII":
                ...
                this.lore.add("&7to &c1.5(HEART_EMOJI)");
                break;
            case "lsII":
                assert false;
            ...
            case "pfIII":
                ...
                this.lore.add("&7Deal &c+5%&7 damage per &c(HEART_EMOJI)");
                this.lore.add("&7you're missing");
                break;
            case "pfII":
                assert false;
                this.lore.add("&9Pain Focus II");
                this.lore.add("&7Deal &c+2%&7 damage per &c(HEART_EMOJI)");
                this.lore.add("&7you're missing");
                break;
            case "pfI":
                assert false;
                this.lore.add("&9Pain Focus");
                this.lore.add("&7Deal &c+1%&7 damage per &c(HEART_EMOJI)");
                this.lore.add("&7you're missing");
                break;
