...
public class itemManager {
    ...
    private static void createBillionaireLS() {
        ...
        lore.add(colorCode("&7to &c1.5(HEART_EMOJI)"));
        meta.setLore(lore);
        meta.addEnchant(Enchantment.LUCK, 1, false);
    ...
    private static void createPerun() {
        ...
        lore.add(colorCode("&elightning &7for &c1(HEART_EMOJI) &7+ &c1(HEART_EMOJI)"));
    ...
    private static void createGamble() {
        ...
        lore.add(colorCode("&d50% chance &7to deal&c 2(HEART_EMOJI) &7true"));
    ...
    private static void createExecutioner() {
        ...
        lore.add(colorCode("&7Hitting an enemy to below&c 2(HEART_EMOJI)"));
