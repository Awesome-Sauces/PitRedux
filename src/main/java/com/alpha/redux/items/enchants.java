...
public class enchants {
    ...
    private static void createLores() {
        ...
        lore.add(colorCode("&7Passively regain &c1(HEART_EMOJI)&7 every 4"));
        ...
        lore.add(colorCode("&7You heal &c1.25(HEART_EMOJI)"));
        lore.add(colorCode("&7Gain &c+1.5(HEART_EMOJI) &7damage vs them for 30s"));
        lore.add(colorCode("&7They take &c0.5(HEART_EMOJI)&7 true damage"));
        ...
        lore.add(colorCode("&7Gain &6+2(HEART_EMOJI)&7 absorption on kill"));
        lore.add(colorCode("&7(max &6(HEART_EMOJI)&7)"));
        ...
        lore.add(colorCode("&7Deal &c+0.5(HEART_EMOJI) &7true damage against"));
        lore.add(colorCode("&7players wearing leather pants but"));
        lore.add(colorCode("&7take &c0.3(HEART_EMOJI)"));
    ...
    private static void createMaldingChestplate() {
        ...
        lore.add(colorCode("&7deals less than &c1.5(HEART_EMOJI)&7 &7damage,"));
