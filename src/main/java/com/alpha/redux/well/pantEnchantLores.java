    ...
    public pantEnchantLores(String enchant) {
        switch (enchant){
            case "goldheartIII":
                ...
                lore.add("&7Gain &6+2(HEART_EMOJI)&7 absorption on kill");
                lore.add("&7(max &6(HEART_EMOJI)&7)");
                break;
            case "goldheartII":
                

                lore.add("&9Golden Heart II");
                lore.add("&7Gain &6+1(HEART_EMOJI)&7 absorption on kill");
                lore.add("&7(max &6(HEART_EMOJI)&7)");
                break;
            case "goldheartI":
                
                lore.add("&9Golden Heart");
                lore.add("&7Gain &6+0.5(HEART_EMOJI)&7 absorption on kill");
                lore.add("&7(max &6(HEART_EMOJI)&7)");
                break;
            ...
            case "rgmIII":
                ...
                lore.add("&7You heal &c1.2(HEART_EMOJI)");
                lore.add("&7Gain &c+1.5(HEART_EMOJI)&f &cdamage &fvs them for &e30s");
                lore.add("&7They take &c1(HEART_EMOJI) &ftrue damage");
                break;
            case "rgmII":
                ...
                lore.add("&7You heal &c1.5(HEART_EMOJI)");
                lore.add("&7They take &c.5(HEART_EMOJI) &ftrue damage");
                break;
            case "rgmI":
                ...
                lore.add("&7When a player hits you from");
                lore.add("&7above ground &e3 times &fin a row:");
                lore.add("&7You heal &c1(HEART_EMOJI)");
                lore.add("&7They take &c1(HEART_EMOJI) &ftrue damage");
                break;
            case "regIII":
                ...
                lore.add("&7deals less than &c1.5(HEART_EMOJI)&7 &7damage,");
