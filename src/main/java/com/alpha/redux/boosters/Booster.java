...
import com.alpha.redux.renownShop.CookieMonster.MonsterData;
    ...
    public static boolean activateBooster(Player player, String booster){
        ...
        switch (booster){
            ...
            case "BOT":
                ...
                for (int i = 0; i < 30; i++) {
                    HunterAPI.createHunterNon(locations.getBotSpawnLocation(Bukkit.getWorld("world")), 1800);
                    HunterAPI.createHunterNon(locations.getBotSpawnLocation(Bukkit.getWorld("lobby")), 1800);
                }
